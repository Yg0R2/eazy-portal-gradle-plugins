...
gradlePlugin {
    plugins {
        create("eazySettings") {
            ...
            implementationClass = "org.eazyportal.gradle.dummysettings.EazySettingsPlugin"
            displayName = "Dummy Settings"
            description = "Receiver entry point: auto-applies eazy-project to every subproject and feeds the eazy-portal-core version."
        }
    }
}
