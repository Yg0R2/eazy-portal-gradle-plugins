...
/**
 * `default` — the escape hatch for a non-standard module (§5.2). Gets `kotlin-project` + `eazy-portal-core-test` (from
...
internal class DefaultProjectConfigurer(
    ...
    override fun configureDependencies() {
        // none — only eazy-portal-core-test (added by the base template) + the BOM.
    }
