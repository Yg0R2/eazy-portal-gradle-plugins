...
class PrepareRepositoryForReleaseActionTest : ReleaseActionBaseTest() {
    ...
    fun test_execute(scmConfig: ScmConfig) {
        ...
        justRun { scmActions.fetch(projectFile, scmConfig.remote, scmConfig.releaseBranch, scmConfig.featureBranch) }

        underTest = PrepareRepositoryForReleaseAction(createProjectContext(projectActions), scmActions, scmConfig)
        ...
        verifySequence {
            ...
            scmActions.fetch(projectFile, scmConfig.remote, scmConfig.releaseBranch, scmConfig.featureBranch)
        }
    }
